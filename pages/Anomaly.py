...
from Back_End import csv_processor4  # Assuming the modified backend logic is in this script
...
# ---- TITLE ----
st.markdown('<h1 class="title">📜 Generate Reports (Anomaly)</h1>', unsafe_allow_html=True)
...
uploaded_file_report = st.file_uploader("Choose a CSV file", type=["csv"])
...
if uploaded_file_report:
    ...
    with st.spinner("Processing... ⏳"):
        ...
        processed_output = csv_processor4.process_file(uploaded_file_report)
